...
# from nets.repvit import repvit_m1_1
...
class YoloBody(nn.Module):
    def __init__(self, input_shape, num_classes, phi, pretrained=False):
        ...
        # self.backbone   = repvit_m1_1(pretrained=1, out_indices = [7,21,24])
        self.conv_64_128 = torch.nn.Conv2d(64, 128, kernel_size=1)
    ...
    def forward(self, x):
        ...
        # print(f'feat0: {feat0.shape}feat1: {feat1.shape}, feat2: {feat2.shape}, feat3: {feat3.shape}')
        feat1 = self.conv_64_128(feat1)
        feat2 = self.conv_160_256(feat2)
        feat3 = self.conv_256_512(feat3)
